...
data=read.csv('/Users/ali/Desktop/aug/volcano_plot/mikes_age.csv')%>%select(Gene.Symbol, log2.FC., fdr_p)
data[2,1]
...
library(xlsx)
de$gene_symbol
result_path='/Users/ali/Desktop/Jul/apoe2_paper/divide_by_sum/multi_cca/volcano_plot/multi_cca_volcano/apoe2_mikes_sig_age/RNA_result_ordered.xlsx'
