...
mike_path='/Users/ali/Desktop/aug/volcano_plot/multi_cca_volcano/apoe2_mikes_sig_sex/mikes.csv'
...
##### add log2.and p vals .number from mikes excel sheet
mikes_path='/Users/ali/Desktop/aug/volcano_plot/multi_cca_volcano/apoe2_mikes_sig_sex/mikes.csv'
mikes=read.csv(mikes_path)


Ens_to_sym=read.delim('/Users/ali/Desktop/aug/volcano_plot/multi_cca_volcano/micewithsymbol.txt',sep="\t", header = T)
