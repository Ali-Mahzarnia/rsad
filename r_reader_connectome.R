...
path_master='/Users/ali/Desktop/nov/RSAD/qial_animals_with_age.xlsx'
...
RNA=read.delim('/Users/ali/Desktop/nov/RSAD/micewithsymbol.txt',sep="\t", header = T)
RNA=t(RNA)
...
response2$Genotype[response2$Genotype =="APOE44HN"] = "APOE44"


dodge <- position_dodge(width = 1)

plot1a<-ggplot(response2, aes(x=as.factor(Sex), y=as.numeric(Rsad1), fill = Genotype)) +
  ...
  theme_bw()
plot1a
ggsave("mouse_Rsad1_outliers.png", dpi = 300)
summary(aov(Rsad1 ~ Sex*Genotype, data = response2))
